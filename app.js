...
window.addEventListener('beforeinstallprompt', e => {
  ...
  // Make Android install button active
...
window.addEventListener('appinstalled', () => {
  ...
  hideInstallGuide();
  showToast('✅ TableDesk installed! Check your Home Screen.');
});

// Android install button inside guide
document.getElementById('androidInstallBtn')?.addEventListener('click', async () => {
  if (deferredInstallPrompt) {
    ...
    showToast('Use Chrome menu (⋮) → Add to Home screen');
  }
});

// ── INSTALL GUIDE OPEN / CLOSE ───────────────
...
function showInstallGuide() {
  const { ios, android, standalone } = detectPlatform();

  // Hide all sections first
  document.getElementById('androidSection').classList.remove('show');
  document.getElementById('iosSection').classList.remove('show');
  document.getElementById('desktopSection').classList.remove('show');
  document.getElementById('alreadyInstalled').classList.remove('show');
  ...
  if (standalone) {
    ...
    // Desktop or unknown — show both Android and Desktop
    document.getElementById('androidSection').classList.add('show');
    document.getElementById('desktopSection').classList.add('show');
  }
...
document.getElementById('installOverlay')?.addEventListener('click', hideInstallGuide);
